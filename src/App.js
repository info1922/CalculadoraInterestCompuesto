...
const compoundInterest = (deposito, contribution, years, rate) => {
  let total = deposito;
...
function App() {
  ...
  const handleSubmit = ({deposit, contribution, years, rate}) => {
    const val = compoundInterest(
      Number(deposit), Number(contribution), Number(years), Number(rate))
      console.log(val);
      ...
      <Section>
        ...
        >
          ...
          <Form>
            ...
            <Input name="rate" label="Intéres estimado" />
